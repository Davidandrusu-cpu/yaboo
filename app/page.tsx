  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="products" className="py-20 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Produsele noastre</h2>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">De ce Yaboo?</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
                ...
                <div className="bg-secondary text-secondary-foreground rounded-2xl overflow-hidden transition-transform duration-300 group-hover:scale-[1.02]">
                  <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="relative aspect-square bg-gradient-to-br from-accent/20 to-transparent p-8 flex items-center justify-center">
                      <Image src={bundleProduct.image} alt={bundleProduct.name} fill className="object-contain p-8" />
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Yaboo! vs Competitia</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
